...
import { fetchDevelopers, createTask } from "../../utils/api";
...
function TaskCreate() {
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const newTask = await createTask(auth.token, values);
      console.log(newTask);
      ...
      showAlert(
        "failure",
        "Creating the task failed. Server responded with the following error: " +
